...
| wrongdoing 词义精度（违规行为） | ✗ | 写成"糟糕的执行"，道德负面判断完全丢失 |
| have an easier time of doing 固定搭配 | ✗ | 拆散成"有很轻松的时期"，搭配意义完全丢失 |
| a blow to their reputations 关键词块 | ✗ | reputation 漏译，blow to 译成"报导"，方向和内容均错 |
| 主干因果结构：directors avoid blow if they leave before news breaks | △ | 主干因果方向对（离开→避免），但"时期"代替"轻松度"，逻辑链不完整 |
| even if 让步逻辑：事后回溯可证明当时在场 | △ | 让步关系识别出来了，但 wrongdoing 和 break 译偏，语义模糊 |
